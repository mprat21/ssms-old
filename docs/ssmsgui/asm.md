...
| Risks                                                                                   | The following risks are displayed in case the user changed his smartphone (for example jailbreaking on iOS) or his app. You will find more detailed information in the separated risk documentation<br/>* Manipulation <br/> * MaliciousApp <br/>* Uid <br/> * CodeInjection <br/>* RunAsRoot <br/> * MemoryProtection <br/> * Emulator
