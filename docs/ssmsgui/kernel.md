...
![navigationmenu](./kernel-files/kernel_navigationmenu.png)
...
![kernelusers](./kernel-files/kernel_users.png)  
...
![kerneladvancedsearch](./kernel-files/kernel_advancedsearch.png)  
...
![kernelbuttons](./kernel-files/kernel_buttons.png)  
...
![kernelactionicons](./kernel-files/kernel_actionicons.png)  
...
![kernelinformationview](./kernel-files/kernel_informationview.png)  
...
![kernelmoduleinfo](./kernel-files/kernel_moduleinfo.png)  
...
![kerneldiagnostic](./kernel-files/kernel_diagnostic.png)  
...
![kerneloperatormanagement](./kernel-files/kernel_operatormanagement.png)  
...
![kerneladdoperator](./kernel-files/kernel_addoperator.png)  
...
![kernelsslcertificatecreation](./kernel-files/kernel_sslcertificatecreation.png)  
...
![kernelrolemanagement](./kernel-files/kernel_rolemanagement.png)  
...
![kerneladdrole](./kernel-files/kernel_addrole.png)  
...
![kernelmodifyrole](./kernel-files/kernel_modifyrole.png)  
...
![kernelrolepermissions](./kernel-files/kernel_rolepermissions.png)  
...
![kernelusersview](./kernel-files/kernel_usersview.png)  
...
![kerneladduser](./kernel-files/kernel_adduser.png)  
...
![kernelroleaccessauth](./kernel-files/kernel_roleaccessauth.png)  
...
![kernelportalservices](./kernel-files/kernel_portalservices.png)  
...
![kernellicensemanagementview](./kernel-files/kernel_licensemanagementview.png)  
...
![kernelcapasswordchange](./kernel-files/kernel_capasswordchange.png)  
...
![kernelauditview](./kernel-files/kernel_auditview.png)  
...
![kernelmonitoringview](./kernel-files/kernel_monitoringview.png)  
...
![kerneltextresourcesview](./kernel-files/kernel_textresourcesview.png)  
...
![kerneladdlanguage](./kernel-files/kernel_addlanguage.png)  
...
![kernellanguage](./kernel-files/kernel_language.png)  
...
![kerneladdnewkey](./kernel-files/kernel_addnewkey.png)  
...
![kerneldeletekeylanguage](./kernel-files/kernel_deletekeylanguage.png)  

2.	Check box of the key  

![kerneldeletekeykey](./kernel-files/kernel_deletekeykey.png)  

3.	Delete the key  

![kerneldeletekeycarryout](./kernel-files/kernel_deletekeycarryout.png)  
...
![kernelimport](./kernel-files/kernel_import.png)  
